<?php
    ...
    function tgl_indonesia($tgl)
    {
        ...
        $nama_bulan = array("Januari","Februari","Maret","April",
    ...
    //Fungsi untuk mengubah susunan format tanggal dari from ke database
    ...
    //Fungsi untuk mengubah susunan format tgl dari database ke form
