...
<div class="wrapper">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; <script>document.write(new Date().getFullYear);</script> <a href="#">Bang Ambo University</a>.</strong>
    All rights reserved.
  </footer>
...
<script src="assets/adminlte3/dist/js/pages/dashboard.js"></script>
</body>
</html>
